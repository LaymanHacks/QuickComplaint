...
namespace QuickComplaint.Web.UI.Test.Controllers.Api
{
    ...
    public class ComplaintApiControllerTests
    {
        ...
        private readonly List<Complaint> _repositoryList = new List<Complaint>
        {
        ...
        public void GetDataByComplaintTypeIdPageableTest()
        {
            ...
            _repository
                .Setup(
                    it =>
                        it.GetDataByComplaintTypeIdPageable(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(),
                            It.IsAny<int>()))
                .Returns<int, string, int, int>((complaintTypeId, sortExpression, page, pageSize) =>
                {
            ...
            Assert.AreEqual(_repositoryList.Where(x => x.ComplaintTypeId == complaintTypeId).Take(2).ToList().Count,
                expectedResult.Results.Count);
            Assert.AreEqual(
                _repositoryList.Where(x => x.ComplaintTypeId == complaintTypeId).OrderBy(q => q.Id).FirstOrDefault().Id,
        ...
        {
            _repository
                .Setup(it => it.GetDataByComplaintTypeId(It.IsAny<int>()))
                .Returns<int>(
                    complaintTypeId =>
                    {
            ...
            Assert.AreEqual(_repositoryList.Where(x => x.ComplaintTypeId == complaintTypeIdValue).ToList().Count,
                result.Count);
        }
        ...
        public void GetDataByReportingPartyIdPageableTest()
        {
            ...
            _repository
                .Setup(
                    it =>
                        it.GetDataByReportingPartyIdPageable(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(),
                            It.IsAny<int>()))
                .Returns<int, string, int, int>((reportingPartyId, sortExpression, page, pageSize) =>
                {
            ...
            Assert.IsTrue(result.TryGetContentValue(out expectedResult));
            Assert.AreEqual(_repositoryList.Where(x => x.ReportingPartyId == reportingPartyId).Take(2).ToList().Count,
                expectedResult.Results.Count);
            Assert.AreEqual(
                _repositoryList.Where(x => x.ReportingPartyId == reportingPartyId)
                    .OrderBy(q => q.Id)
                    .FirstOrDefault()
                    .Id, expectedResult.Results.FirstOrDefault().Id);
        }
        ...
        {
            _repository
                .Setup(it => it.GetDataByReportingPartyId(It.IsAny<int>()))
                .Returns<int>(
                    reportingPartyId =>
                    {
            ...
            Assert.AreEqual(_repositoryList.Where(x => x.ReportingPartyId == reportingPartyIdValue).ToList().Count,
                result.Count);
        }
        ...
        {
            _repository
                .Setup(it => it.Insert(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()))
                .Returns<int, string, string, int>(
                    (complaintTypeId, description, locationDetails, reportingPartyId) =>
                    {
                        _repositoryList.Add(new Complaint(complaintTypeId, description, locationDetails,
                            reportingPartyId));
                    });
        ...
        public void Update_Should_Update_A_Complaint()
        {
            _repository
                .Setup(
                    it =>
                        it.Update(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(),
                            It.IsAny<int>()))
                .Callback<int, string, string, int, int>(
                    (complaintTypeId, description, locationDetails, reportingPartyId, id) =>
                    {
